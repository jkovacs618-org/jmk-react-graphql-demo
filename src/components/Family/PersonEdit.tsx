            ...
            executeLoad({
                ...
                onCompleted: (data) => {
                    if (typeof data.person !== 'undefined' && data.person) {
                        setPerson({
                            ...data.person,
                            relationship: (data.person.person2Relationship ? data.person.person2Relationship.type : ''),
                        });
                ...
                <div className="form-group">
                    ...
                    <div className="mb-2">
                        ...
                        <TextInput
                            ...
                            name="birthDate"
                            type="date"
                            value={person?.birthDate ? dayjs(person.birthDate).format('YYYY-MM-DD') : ''}
                            placeholder=""
                    ...
                    {isDeceased ?
                        <div className="mb-2">
                            ...
                            <TextInput
                                ...
                                name="deathDate"
                                type="date"
                                value={person?.deathDate ? dayjs(person.deathDate).format('YYYY-MM-DD') : ''}
                                placeholder=""
