          ...
          >
              <div className="flex mb-2">
                ...
                <div className="ml-auto mr-5">
                  <FontAwesomeIcon icon="times" className="text-2xl text-gray-500 font-bold cursor-pointer" onClick={closeMenu} />
                </div>
                <div className="float-none"></div>
              </div>

              <div className="float-none">
                <SideMenuLink path="/dashboard" label="Dashboard" prefix="fas" icon="table-cells-large" />
                ...
                <SideMenuLink path="/services" label="Accounts" prefix="fas" icon="building-user" />
              </div>
