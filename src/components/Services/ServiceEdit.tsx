...
const ServiceEditForm: React.FC = () => {
            ...
            executeLoad({
                ...
                onCompleted: (data) => {
                    ...
                    if (typeof data.serviceAccount !== 'undefined' && data.serviceAccount) {
                        ...
                        setServiceAccount({
                            ...data.serviceAccount,
                            organizationExternalId: (data.serviceAccount.organization ? data.serviceAccount.organization.externalId : null),
                            serviceTypeExternalId: (data.serviceAccount.serviceType ? data.serviceAccount.serviceType.externalId : null),
                        });
                    }
                    else {
                        navigate('/services');
    ...
    const updateModelQuery = gql`
        mutation UpdateServiceAccountMutation($externalId: String!, $serviceAccount: ServiceAccountInput!) {
                ...
                <div className="form-group">
                    ...
                    <div className="mb-2">
                        ...
                        <TextInput
                            ...
                            name="startDate"
                            type="date"
                            value={serviceAccount?.startDate ? dayjs(serviceAccount.startDate).format('YYYY-MM-DD') : ''}
                    ...
                    <div className="mb-2">
                        ...
                        <TextInput
                            ...
                            name="endDate"
                            type="date"
                            value={serviceAccount?.endDate ? dayjs(serviceAccount.endDate).format('YYYY-MM-DD') : ''}
