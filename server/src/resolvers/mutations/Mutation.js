...
export const Mutation = {
  ...
  createServiceAccount, updateServiceAccount, deleteServiceAccount,
  createServiceNote, createEventNote, updateNote, deleteNote,
  createServiceTag, createEventTag, deleteEventTag, deleteServiceTag,
};