    ...
    return (
        <div>
            <NavLink to="/account" className="nav-link">
                ...
                {authUser ? (<span>{authUser.nameFirst} {authUser.nameLast}</span>) : null}

            </NavLink>

            <Link to="#" onClick={handleLogout} className="text-white hover:text-gray-300 cursor-pointer ml-6" title="Log Out">
